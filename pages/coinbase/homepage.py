...
class HomePage:
    ...
    def __init__(self, driver, spawn=True, close_cookie_banner=True):
        ...
        close_cookie_banner: bool
            ...
            open and can hide elements of the page.
        """
    ...
    protected_insurance_link_loc= (by.XPATH, "//a[@title=" +
                 "'Learn how your crypto is covered by our insurance policy']")
    industry_best_practices_link_loc = (by.XPATH,"//a[@title='Learn how we" +
                    "implement industry best practices for account security']")
    ...
    def build_elements(self):
        ...
        self.bitcoin_buy_button=  Button(self.driver,
                                         self.bitcoin_buy_button_loc)
        ...
        self.cookie_banner_dismiss_button =  Button(self.driver,
                                         self.cookie_banner_dismiss_button_loc)
